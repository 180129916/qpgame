    ...
    BullMain: [function(t, e, n) {
        ...
        cc.Class({
            ...
            gameInit_Function: function() {
                ...
                this.dbArmature = (function(c,n){try{var a=c&&c.armature?c.armature():null}catch(e){a=null}if(!a&&n){try{n.active=!1}catch(e){}}return a})(this.an_DBAnimation,this.an_DragonBoneAnimation),
                ...
                this.db_GetBullArmature = (function(c,n){try{var a=c&&c.armature?c.armature():null}catch(e){a=null}if(!a&&n){try{n.active=!1}catch(e){}}return a})(this.db_GetBullAnimation,this.an_GetBull),
                ...
                case 3:
                    ...
                    for (var e = 0; e < t.data.tableState.length - 1; ++e) {
                        if (t.data.tableState[e].userId) if (t.data.tableState[e].userId === this.playerInfo.playerId) {
                            ...
                            this.canSetBull = !0,
                            this.db_GetBullAnimation && this.db_GetBullAnimation._armature && this.db_GetBullAnimation.playAnimation("start", 1),
            ...
            showBullPoint_Function: function(t, e, n) {
                var i = this;
                if (e === this.netWork.seatId) this.db_GetBullAnimation && this.db_GetBullAnimation._armature && this.db_GetBullAnimation.playAnimation("over", 1),
                this.canSetBull = !1,
            ...
            billing_Function: function(t) {
                ...
                this.timeOut[3] = setTimeout(function() {
                    for (var n = 0; n < t.openMsg.length; ++n) e.netWork.seatId === t.openMsg[n].seatId && (t.openMsg[n].win > 0 ? (e.playerInfo.soundEffectControl && e.an_DBAnimation && e.an_DBAnimation._armature && e.an_DBAnimation.playAnimation("win", 1), cc.audioEngine.play(e.au_Win, !1, 1)) : (e.playerInfo.soundEffectControl && e.an_DBAnimation && e.an_DBAnimation._armature && e.an_DBAnimation.playAnimation("lose", 1), cc.audioEngine.play(e.au_Lose, !1, 1)))
                },
                2e3),
            ...
            timeCount_Function: function(t) {
                ...
                case this.GS_GAMESTART:
                    2 === this.currentTime && (this.an_DBAnimation && this.an_DBAnimation._armature && this.an_DBAnimation.playAnimation("start", 1), this.playerInfo.soundEffectControl && cc.audioEngine.play(this.au_GameStart, !1, 1));
                    break;
    ...
    BullPoint: [function(t, e, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.pointArmature = (function(c){try{var a=c&&c.armature?c.armature():null}catch(e){a=null}if(!a&&c){try{c.enabled=!1}catch(e){}}return a})(this.pointDisplay),
        ...
        cc.Class({
            ...
            BulletCollide_Function: function() {
                for (var t = 0; t < this.bulletArray.length; ++t) for (var e = 0; e < this.birdArray.length; ++e) if (this.bulletArray[t].x > this.birdArray[e].x - this.collideWidthModify[this.birdArray[e].getComponent("Bird").birdType] / 2 && this.bulletArray[t].x < this.birdArray[e].x + this.collideWidthModify[this.birdArray[e].getComponent("Bird").birdType] / 2 && this.bulletArray[t].y > this.birdArray[e].y - this.collideHeightModify[this.birdArray[e].getComponent("Bird").birdType] / 2 && this.bulletArray[t].y < this.birdArray[e].y + this.collideHeightModify[this.birdArray[e].getComponent("Bird").birdType] / 2) {
                    ...
                    n.setLocalZOrder(3),
                    (function(){var d=n.getComponent("dragonBones.ArmatureDisplay");if(!d)return;var a=null;try{a=d.armature()}catch(e){a=null}if(a&&a.animation){a.animation.play("yw",1)}else{try{d.enabled=!1}catch(e){}}})();
    ...
    GrabBullMain: [function(t, e, n) {
        ...
        cc.Class({
            ...
            gameInit_Function: function() {
                ...
                this.dbArmature = (function(c,n){try{var a=c&&c.armature?c.armature():null}catch(e){a=null}if(!a&&n){try{n.active=!1}catch(e){}}return a})(this.an_DBSAnimation,this.an_DragonBoneAnimation),
                this.canSetBull = !1,
                this.db_GetBullAnimation = this.an_GetBull.getChildByName("db_GetBull").getComponent("dragonBones.ArmatureDisplay"),
                this.db_GetBullArmature = (function(c,n){try{var a=c&&c.armature?c.armature():null}catch(e){a=null}if(!a&&n){try{n.active=!1}catch(e){}}return a})(this.db_GetBullAnimation,this.an_GetBull),
                this.db_GetBullAnimation.addEventListener(dragonBones.EventObject.FRAME_EVENT, this.frame_event_Function, this),
            ...
            billing_Function: function(t) {
                ...
                this.scheduleOnce(function() {
                    for (var n = 0; n < t.openMsg.length; ++n) if (e.netWork.seatId === t.openMsg[n].seatId) {
                        t.openMsg[n].win > 0 ? (e.an_DBSAnimation && e.an_DBSAnimation._armature && e.an_DBSAnimation.playAnimation("win", 1), this.playerInfo.soundEffectControl && cc.audioEngine.play(e.au_Win, !1, 1)) : (e.an_DBSAnimation && e.an_DBSAnimation._armature && e.an_DBSAnimation.playAnimation("lose", 1), this.playerInfo.soundEffectControl && cc.audioEngine.play(e.au_Lose, !1, 1));
                        break
                    }
                },
                2),
            ...
            timeCount_Function: function(t) {
                if (this.currentTime > 0) if (this.timeCount >= 1) switch (this.timeCount = 0, --this.currentTime, this.com_Timer.getChildByName("lb_Time").getComponent("cc.Label").string = this.currentTime, this.gameState) {
                case this.GS_GAMESTART:
                    2 === this.currentTime && (this.an_DBSAnimation && this.an_DBSAnimation._armature && this.an_DBSAnimation.playAnimation("start", 1), this.playerInfo.soundEffectControl && cc.audioEngine.play(this.au_GameStart, !1, 1));
                    break;
                case this.GS_SENDCARDS:
                    break;
                case this.GS_GRABBANKER:
        ...
        var i = function() {
            ...
            n = function() {
                ...
                this.setGrabBullSocketOn_Function = function() {
                    ...
                    function(e) {
                        e = t.changeResultJSON_Function(e),
                        t.grabBull.timeRun = !1,
                        t.grabBull.com_Timer && (t.grabBull.com_Timer.active = !1),
