...
//开奖结果
exports.addMatch = function addMatch(Info,serverId,tableid){
	var sql = "INSERT INTO matchlog(open11,open12,open21,open22,open31,open32,open41,open42,open2winbet,open3winbet,open4winbet,tableId,serveId) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
	var values = [];
	for(var i = 0 ; i < 8 ;i ++){
		values.push(Info.card[i]);
	}
